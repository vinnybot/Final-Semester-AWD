...
namespace MVCHOT2.Migrations
{
    ...
    [Migration("20230424184139_AddIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCHOT2.Models.DomainModels.Category", b =>
                {
            ...
            modelBuilder.Entity("MVCHOT2.Models.DomainModels.Customer", b =>
                {
            ...
            modelBuilder.Entity("MVCHOT2.Models.DomainModels.Product", b =>
                {
            ...
            modelBuilder.Entity("MVCHOT2.Models.DomainModels.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MVCHOT2.Models.DomainModels.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MVCHOT2.Models.DomainModels.Product", b =>
                {
                    b.HasOne("MVCHOT2.Models.DomainModels.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MVCHOT2.Models.DomainModels.Product", null)
                        .WithMany("Products")
